namespace AutoLotDAL.Migrations
{
    ...
    public partial class AddBaseId : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Orders", "Inventory_Id", c => c.Int(nullable: false));
            ...
            CreateIndex("dbo.Orders", "Inventory_Id");
            AddForeignKey("dbo.Orders", "Customer_Id", "dbo.Customers", "Id");
            AddForeignKey("dbo.Orders", "Inventory_Id", "dbo.Inventory", "Id");
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "Inventory_Id", "dbo.Inventory");
            DropForeignKey("dbo.Orders", "Customer_Id", "dbo.Customers");
            DropIndex("dbo.Orders", new[] { "Inventory_Id" });
            ...
            DropColumn("dbo.Orders", "Inventory_Id");
